...
(function ($, window, document, Date) {
    ...
    function _setActive(el, state) {
        return el[state ? 'on' : 'off']('mousenter mouseout', _stayActive).toggleClass(_selectedClass, state);
    }
    ...
    function _makeDefaultButton(options) {
        ...
        return $('<span id="MonthPicker_Button_' + this.id + '" class="month-picker-open-button">' + options.i18n.buttonText + '</span>').jqueryUIButton({
            text: false,
            icons: {
    ...
    var _markup = '<div class="ui-widget-header month-picker-header ui-corner-all">' + '<table class="month-picker-year-table">' + '<tr>' + '<td class="month-picker-previous"><a /></td>' + '<td class="month-picker-title"><a /></td>' + '<td class="month-picker-next"><a /></td>' + '</tr>' + '</table>' + '</div>' + '<div>' + '<table class="month-picker-month-table" />' + '</div>';
    ...
    $.widget("KidSysco.MonthPicker", {
        ...
        _create: function _create() {
            ...
            this._titleButton = $('.month-picker-title', _menu).click($proxy(this._showYearsClickHandler, this)).find('a').jqueryUIButton().removeClass(_defaultClass);

            this._applyJumpYearsHint();
            this._createValidationMessage();

            this._prevButton = $('.month-picker-previous>a', _menu).jqueryUIButton({ text: false }).removeClass(_defaultClass);

            this._nextButton = $('.month-picker-next>a', _menu).jqueryUIButton({ text: false }).removeClass(_defaultClass);
        ...
        GetSelectedMonthYear: function GetSelectedMonthYear() {
        ...
        Open: function Open(event) {
            ...
            if (!_opts.Disabled && !this._visible) {
                ...
                if (_isInline(_elem)) {
                    ...
                    $(document).on('mousedown' + _eventsNs + this.uuid, $proxy(this.Close, this)).on('keydown' + _eventsNs + this.uuid, $proxy(this._keyDown, this));
        ...
        Close: function Close(event) {
            ...
            if (!_isInline(_elem) && this._visible) {
                ...
                this._visible = false;
                _openedInstance = null;
                $(document).off('keydown' + _eventsNs + this.uuid).off('mousedown' + _eventsNs + this.uuid);
        ...
        ParseMonth: function ParseMonth(str, format) {
            try {
        ...
        FormatMonth: function FormatMonth(date, format) {
            try {
        ...
        _setSelectedMonth: function _setSelectedMonth(_selMonth) {
            var month = _encodeMonth(this, _selMonth),
                _el = this.element;
        ...
        _applyJumpYearsHint: function _applyJumpYearsHint() {
            _applyButtonHint(this._titleButton, this._i18n('jumpYears'));
        },

        _i18n: function _i18n(str) {
        ...
        _parseMonth: function _parseMonth(str, format) {
            return this.ParseMonth(str || this.element.val(), format || this.options.MonthFormat);
        },

        _formatMonth: function _formatMonth(date, format) {
        ...
        _createButton: function _createButton() {
            ...
            this._monthPickerButton = (_btnOpt instanceof $ ? _btnOpt : $(_btnOpt)).each(function () {
                if (!$.contains(document.body, this)) {
                    _removeOldBtn = true;
                    $(this).insertAfter(_elem);
                }
            }).on(click, $proxy(this.Toggle, this)).on('mousedown' + _eventsNs, function (r) {
                r.preventDefault();
            });
        ...
        _updateFieldEvents: function _updateFieldEvents() {
        ...
        _createValidationMessage: function _createValidationMessage() {
        ...
        _setRTL: function _setRTL(value) {
        ...
        _position: _hasPosition ? function ($menu) {
        ...
        _setUseInputMask: function _setUseInputMask() {
            if (!this._isMonthInputType) {
                try {
        ...
        _setDisabledState: function _setDisabledState() {
            var isDisabled = this.options.Disabled,
                _elem = this.element;
        ...
        _getPickerYear: function _getPickerYear() {
            return this._pickerYear;
        },

        _setPickerYear: function _setPickerYear(year) {
        ...
        _updateAlt: function _updateAlt(noop, date) {
        ...
        _chooseMonth: function _chooseMonth(month) {
        ...
        _chooseYear: function _chooseYear(year) {
            this._backToYear = 0;
        ...
        _showMonths: function _showMonths() {
            var _months = this._i18n('months');

            this._prevButton.attr('title', this._i18n('prevYear')).off(click).on(click, $proxy(this._addToYear, this, -1));

            this._nextButton.attr('title', this._i18n('nextYear')).off(click).on(click, $proxy(this._addToYear, this, 1));
            ...
            $.each(_months, function (index, monthName) {
                $(me._buttons[index]).on(click, { month: index + 1 }, _onMonthClick).jqueryUIButton('option', 'label', monthName);
            });

            this._decorateButtons();
        },

        _showYearsClickHandler: function _showYearsClickHandler() {
            this._buttons.removeClass(_todayClass);
            if (!this._backToYear) {
        ...
        _showYears: function _showYears() {
            ...
            this._prevButton.attr('title', this._i18n('prev12Years')).off(click).on(click, $proxy(this._addToYears, this, -AMOUNT_TO_ADD));

            this._nextButton.attr('title', this._i18n('next12Years')).off(click).on(click, $proxy(this._addToYears, this, AMOUNT_TO_ADD));
        ...
        _onMonthClick: function _onMonthClick(event) {
            this._chooseMonth(event.data.month);
            this.Close(event);
        },

        _onYearClick: function _onYearClick(event) {
            this._chooseYear(event.data.year);
        },

        _addToYear: function _addToYear(amount) {
        ...
        _addToYears: function _addToYears(amount) {
        ...
        _ajustYear: function _ajustYear(_opts) {
        ...
        _decorateButtons: function _decorateButtons() {
            ...
            for (var i = 0; i < 12; i++) {
                ...
                $(this._buttons[i]).jqueryUIButton({ disabled: !_isBetween }).toggleClass(_todayClass, _isBetween && _month == _todaysMonth); // Highlights today's month.
            }
        }
    });
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/extract-text-webpack-plugin/loader.js??ref--10-0!../../../node_modules/style-loader/index.js!../../../node_modules/css-loader/index.js??ref--10-2!../../../node_modules/postcss-loader/index.js??ref--10-3!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js??ref--10-5!./MonthPicker.min.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/extract-text-webpack-plugin/loader.js??ref--10-0!../../../node_modules/style-loader/index.js!../../../node_modules/css-loader/index.js??ref--10-2!../../../node_modules/postcss-loader/index.js??ref--10-3!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js??ref--10-5!./MonthPicker.min.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/extract-text-webpack-plugin/loader.js??ref--8-0!../../../node_modules/style-loader/index.js!../../../node_modules/css-loader/index.js??ref--8-2!../../../node_modules/postcss-loader/index.js??ref--8-3!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js??ref--8-5!./test.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/extract-text-webpack-plugin/loader.js??ref--8-0!../../../node_modules/style-loader/index.js!../../../node_modules/css-loader/index.js??ref--8-2!../../../node_modules/postcss-loader/index.js??ref--8-3!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js??ref--8-5!./test.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
