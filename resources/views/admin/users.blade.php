	...
	<div class="small-12 medium-6 column">
		...
		<table border = "1" id="create_user_table">
			...
			<tbody>
				<tr>
					<td>
						<label for="Name" class="{{ $errors->first('name') ? 'error' : '' }}">Name</label>
					</td>
					<td>
				...
				<tr>
					<td>
						<label for="password_confirmation" class="{{ $errors->first('password_confirmation') ? 'error' : '' }}">Confirm Password</label>
					</td>
					<td>
